...
fun listPolynomialsExample() {
    ...
    ) // true, because 2 + (-3) * (3-x) + (3-x)^2 = 2 - 3x + x^2
    ...
    Double.algebra.listRationalFunctionSpace {
        val rationalFunction1: ListRationalFunction<Double> =
            ListRationalFunction(listOf(2.0, -3.0, 1.0), listOf(3.0, -1.0))
        // It's just (2 - 3x + x^2)/(3 - x)

        val rationalFunction2: ListRationalFunction<Double> =
            ListRationalFunction(listOf(5.0, -4.0, 1.0), listOf(3.0, -1.0))
...
fun numberedPolynomialsExample() {
    ...
    with(Int.algebra) {
        ...
        println(polynomial1 == polynomial2) // true
        // and even
        val polynomial3: NumberedPolynomial<Int> =
            57.asNumberedPolynomial() // This one actually does not algebraic context!
...
fun labeledPolynomialsExample() {
    ...
    with(Int.algebra) {
        ...
        println(polynomial1 == polynomial2) // true
        // and even
        val polynomial3: LabeledPolynomial<Int> =
            57.asLabeledPolynomial() // This one actually does not algebraic context!
